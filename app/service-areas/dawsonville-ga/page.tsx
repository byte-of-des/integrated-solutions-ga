...
export const metadata: Metadata = {
  ...
  description: 'Professional AV and home technology installation in Dawsonville, GA — TV mounting, home theaters, Starlink, security cameras, networking, and smart home automation for Dawson County homes and businesses.',
}
...
export default function DawsonvillePage() {
  return (
    <>
      <section className={styles.hero}>
        <div className={`container ${styles.heroContent}`}>
          <p className={styles.eyebrow}>Dawson County, GA</p>
          <h1 className={styles.headline}>AV Installation in Dawsonville, GA</h1>
          <p className={styles.sub}>ISG serves Dawsonville and Dawson County with professional AV and home technology installation. Starlink for rural properties, home theaters, security cameras, and smart home systems — done right.</p>
      ...
      <section className={styles.services}>
        <div className="container">
          <h2 className={styles.sectionTitle}>Services in Dawsonville, GA</h2>
      ...
      <section className={styles.local}>
        <div className="container">
          <div className={styles.localInner}>
            <div>
              <h2 className={styles.localTitle}>Serving Dawsonville &amp; Dawson County</h2>
              <p>Dawsonville is growing fast — and so is demand for professional AV and tech installs. Rural properties here often benefit most from Starlink installation and structured networking, and we specialize in exactly that.</p>
              <p>We serve homes and businesses throughout Dawson County, including communities along GA-400, Dawson County's expanding residential corridors, and properties near Lake Lanier's northern shore.</p>
            </div>
            <div className={styles.localHighlights}>
              ...
              <div className={styles.highlight}>
                ...
                <div>
                  ...
                  <p>Based in Cumming, minutes up GA-400</p>
                </div>
              </div>
              <div className={styles.highlight}>
      ...
      <CtaBand
        headline="Schedule your Dawsonville install."
