...
export const metadata: Metadata = {
  ...
  description: 'Professional AV and home technology installation in Canton, GA — TV mounting, home theaters, Starlink, security cameras, networking, and smart home automation for Cherokee County homes and businesses.',
}
    ...
    <>
      <section className={styles.hero}>
        <div className={`container ${styles.heroContent}`}>
          <p className={styles.eyebrow}>Cherokee County, GA</p>
          <h1 className={styles.headline}>AV Installation in Canton, GA</h1>
          <p className={styles.sub}>ISG serves Canton and Cherokee County with professional AV and home technology installation. From historic downtown Canton to the rapidly growing residential communities along I-575 — we're close and ready to help.</p>
      ...
      <section className={styles.services}>
        <div className="container">
          <h2 className={styles.sectionTitle}>Services in Canton, GA</h2>
      ...
      <section className={styles.local}>
        <div className="container">
          <div className={styles.localInner}>
            <div>
              <h2 className={styles.localTitle}>Serving Canton &amp; Cherokee County</h2>
              <p>Canton is one of the fastest-growing cities in Georgia, and new construction here means plenty of homeowners looking to upgrade their AV and technology setup. We work in new builds and established homes alike — no job is too big or too simple.</p>
              <p>We serve homes and businesses throughout Canton and Cherokee County, including Bridgemill, Soleil, Towne Mill, and the neighborhoods along Reinhardt College Parkway and GA-20.</p>
            </div>
            <div className={styles.localHighlights}>
              ...
              <div className={styles.highlight}>
                ...
                <div>
                  ...
                  <p>Serving Cherokee County and surrounding areas</p>
                </div>
              </div>
              <div className={styles.highlight}>
      ...
      <CtaBand
        headline="Schedule your Canton install."
