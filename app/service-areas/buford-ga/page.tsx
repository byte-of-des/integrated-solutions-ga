...
export const metadata: Metadata = {
  ...
  description: 'Professional AV and home technology installation in Buford, GA — TV mounting, home theaters, Starlink, security cameras, networking, smart home automation, and commercial AV for Hall and Gwinnett County.',
}
...
export default function BufordPage() {
  return (
    <>
      <section className={styles.hero}>
        <div className={`container ${styles.heroContent}`}>
          <p className={styles.eyebrow}>Hall &amp; Gwinnett County, GA</p>
          <h1 className={styles.headline}>AV Installation in Buford, GA</h1>
          <p className={styles.sub}>ISG serves Buford homeowners and businesses with professional AV and technology installation. TV mounting, home theaters, Starlink, security cameras, smart home automation, and commercial AV — licensed and insured.</p>
      ...
      <section className={styles.services}>
        <div className="container">
          <h2 className={styles.sectionTitle}>Services in Buford, GA</h2>
      ...
      <section className={styles.local}>
        <div className="container">
          <div className={styles.localInner}>
            <div>
              <h2 className={styles.localTitle}>Serving Buford &amp; Surrounding Areas</h2>
              <p>Buford is a hub for both residential and commercial growth in Northeast Georgia. From new construction neighborhoods to established businesses near the Mall of Georgia corridor, we handle residential and commercial AV installs of any size.</p>
              <p>We serve homes and businesses throughout Buford including the communities along I-985, Lake Lanier Islands, Hamilton Mill, and the surrounding Hall and Gwinnett County neighborhoods.</p>
            </div>
            <div className={styles.localHighlights}>
              ...
              <div className={styles.highlight}>
                ...
                <div>
                  ...
                  <p>Serving Hall and Gwinnett County</p>
                </div>
              </div>
              <div className={styles.highlight}>
      ...
      <CtaBand
        headline="Schedule your Buford install."
